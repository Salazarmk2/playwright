...
def test_example(page: Page) -> None:
    ...
    page.locator("iframe[title=\"Main Content\"]").content_frame.get_by_text("").click()
    page.locator("iframe[title=\"Main Content\"]").content_frame.get_by_placeholder("Search").fill("1099")
    page.goto("https://bctest.dayliff.com/BC160/?node=0000c51d-4792-0000-0c72-2500836bd2d2&page=144&company=UGANDA&dc=0&bookmark=21%3bcgAAAAJ7BTEAMQAyADMAMw%3d%3d")
    ...
    page.locator("iframe[title=\"Main Content\"]").content_frame.get_by_label("Search UGANDA, Posted Documents, Posted Sales Invoices").click()
